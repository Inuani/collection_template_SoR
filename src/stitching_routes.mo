                    ...
                    func(ctx : RouteContext.RouteContext) : Liminal.HttpResponse {
                        ...
                        switch (collection.getItem(firstItemId)) {
                            ...
                            case (?item) {
                                ...
                                let html = Stitching.generateWaitingPage(item, itemsInSession, stitchingStartTime, finalizeToken);
            ...
            Router.get(
                ...
                #query_(
                    func(ctx : RouteContext.RouteContext) : Liminal.HttpResponse {
                        ...
                        let html = Stitching.generateActiveSessionPage(itemsInSession, allItems, stitchingStartTime, finalizeToken);
                        ctx.buildResponse(#ok, #html(html));
                    }
                ),
            ),
            ...
            Router.get(
                ...
                #query_(
                    func(ctx : RouteContext.RouteContext) : Liminal.HttpResponse {
                        ...
                        let allItems = collection.getAllItems();
                        let html = Stitching.generateSessionSuccessPage(itemIds, allItems);
                        ctx.buildResponse(#ok, #html(html));
                    }
                ),
            ),
            ...
            Router.get(
                ...
                #query_(
                    func(ctx : RouteContext.RouteContext) : Liminal.HttpResponse {
                        ...
                        let html = Stitching.generateStitchingErrorPage(errorMsg);
                        ctx.buildResponse(#ok, #html(html));
                    }
                ),
            ),
